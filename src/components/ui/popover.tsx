// This module implements the accessible hover/click popover drawer primitive for secondary options.
...
// This content block displays the contextual popup menu overlay.
